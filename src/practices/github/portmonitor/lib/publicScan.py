...
class PublicScan:
    def __init__(self,file,rate='500'):
    ...
    def diff(self):
        if os.path.exists('out/Result.txt'):
            ...
            if old_change_list:
                ...
                self.change_del_list = list(set(oldlist).difference(self.result_info))
